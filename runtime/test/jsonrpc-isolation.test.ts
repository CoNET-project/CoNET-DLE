...
test('archive JSON-RPC facade source never names L1 public RPC hosts', async () => {
  const files = [
    ...
    'src/archive/syncQualification/engine.ts',
    'src/archive/syncQualification/challenge.ts',
    'src/archive/syncQualification/inventory.ts',
    'src/archive/syncQualification/mac.ts',
    'src/archive/syncQualification/types.ts',
    'src/archive/lab-cli.ts',
